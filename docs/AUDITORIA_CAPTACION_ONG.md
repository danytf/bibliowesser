...
Este documento sirve para auditar las fichas de las ONG desde la
perspectiva de un captador de socios experto.

No verifica datos, cifras ni fuentes. Se asume que toda la información
existente es correcta. El objetivo es evaluar si cada ficha contiene
todo lo que un captador excelente necesita para explicar la
organización, responder objeciones y transmitir confianza.
...
**Veredicto:** ⬜ Excelente / ⬜ Muy completa / ⬜ Completa / ⬜
Requiere mejoras
...
Completamente cubierto. El `claim` combina posicionamiento (principal
financiador privado de investigación oncológica), origen fundacional
(José Biosca, 1953) y objetivo cuantificado a 2030 (superar el 70% de
supervivencia). El campo `problema` reparte con claridad el rol de la
AECC frente al sistema sanitario público ("la sanidad pública trata el
tumor; la AECC se ocupa de todo lo demás"), lo que da al captador una
frase de una línea para explicar por qué existe la organización. No se
detectan carencias en este apartado.
...
está redactado casi como argumentario.
